...
namespace OpenRealEstate.Core.Tests.Address
{
    public class ToFormattedAddressTests
    {
        ...
        public void GivenSomeAddressParts_ToFormattedAddress_ReturnsAFormattedAddress(string streetNumber,
                                                                                      string street,
                                                                                      string suburb,
                                                                                      string state,
                                                                                      ...
                                                                                      string expectedFormattedAddress)
        {
            ...
            // Act.
            var formattedAddress = Core.Address.ToFormattedAddress(streetNumber,
                                                                   street,
                                                                   suburb,
                                                                   state,
                                                                   countryIsoCode,
